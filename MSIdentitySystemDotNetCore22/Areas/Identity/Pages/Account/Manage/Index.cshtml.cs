    ...
    public partial class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.Department != department)
            {
                ...
                var setDepartment = await _userManager.UpdateAsync(user);
                if (!setDepartment.Succeeded)
                {
                    var userId = await _userManager.GetUserIdAsync(user);
                    throw new InvalidOperationException($"Unexpected error occurred setting department for user with ID '{userId}'.");
                }
            }
